  ...
  \cventry
    ...
    {Jun. 2020 - current time} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Working on React, TypeScript, Nextjs, microfronend, PWA, monorepo with Lerna and yarn workspace, Storybook, Figma, Atomic Design Methodology}
        \item {Jest, react-testing-library, Graphql (Apollo), Docker, Kubernetes, GitLab CI/CD.}
      \end{cvitems}
    }
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Migrated from monolith to monorepo with Lerna and Yarn workspace.}
